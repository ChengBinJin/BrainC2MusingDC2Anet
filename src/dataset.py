...
class BrainC2M(object):
    def __init__(self, flags):
        ...
        # tfrecord path
        self.train_tfpath = '../../Data/brain07/tfrecords/train.tfrecords'
        self.test_tfpath = '../../Data/brain07/tfrecords/test.tfrecords'
...
def Dataset(dataset_name, flags, log_path=None):
    ...
    if dataset_name == 'brain07':
        return BrainC2M(flags)
    else:
