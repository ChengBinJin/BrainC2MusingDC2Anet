# ---------------------------------------------------------
# Tensorflow BrainC2M-DC2Anet Implementation
...
class Solver(object):
    ...
    def _make_folders(self):
        if self.flags.is_train:  # train stage
            ...
            self.eval_out_dir = os.path.join("../eval/DC2Anet", self.flags.load_model)
    ...
    def _init_logger(self):
        ...
        if self.flags.is_train:
            ...
            logger.info('is_cycle_consistent: {}'.format(self.flags.is_cycle_consistent))
            logger.info('cycle_consistent_weight: {}'.format(self.flags.cycle_consistent_weight))
            logger.info('is_voxel: {}'.format(self.flags.is_voxel))
            ...
            logger.info('perceputal_mode: {}'.format(self.flags.perceptual_mode))
